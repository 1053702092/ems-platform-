...
# Section 4: 校招验证结果
# ──────────────────────────────────────────────
add_heading2("四、校招验证结果（2026年7月网络调研）")
add_para("以下是对名单中重点企业的校招状态逐一核实的结果，数据来源为各企业官网、招聘平台及高校就业网。", size=9.5)

make_table(
    ["企业名称", "校招状态", "对口岗位", "工作地点", "投递方式", "推荐度"],
    [
        ["中国电气装备集团储能科技", "✅ 2026春招已开\n招~30人", "PCS软件工程师\n研发工程师", "上海（本部）\n许昌/天津/济南", "campus.51job.com/cnkj2026\n刘老师 021-66698846", "⭐⭐⭐⭐⭐\n首推"],
        ["广州储能集团", "✅ 2026校招已启动", "产品研发助理工程师", "广州", "手机端 bjxapp.cn/t/NjMwODE3OA/", "⭐⭐⭐⭐⭐\n首推"],
        ["中国资源循环集团", "✅ 2026春招已开\n秋招也有", "技术专责/管培生\n工艺工程师", "天津（总部）\n深圳/南京/杭州", "zgzh.iguopin.com", "⭐⭐⭐⭐\n专业对口"],
        ["广东新型储能国家研究院", "⚠️ 硕博为主\n部分硕可投", "变流与控制副研究员\n仿真规划副研究员\n19-30k·15薪", "广州白云", "zhaopin@naesic.com", "⭐⭐⭐\n冲刺项"],
        ["宁德时代 CATL", "✅ 2026校招进行中\n20-50w/年", "BMS软件与算法\n储能系统开发", "宁德/厦门/上海\n溧阳/宜宾等", "Talent.CATL.com\ncatl-campus@catl.com", "⭐⭐⭐\n投了不亏"],
        ["国宁新储（福建）科技", "❌ 至今无校招\n全部社招(3年+经验)", "—", "宁德", "gneszhaopin@163.com\n（可发邮件问秋招）", "⭐\n观望"],
    ],
)

add_heading3("关键结论")
conclusions = [
    "① 中国电气装备储能科技 + 广州储能集团 是文件里最值得投的两家，都有明确校招、岗位对口、待遇优厚",
    "② 中国资源循环集团是2025年新央企，化学/材料专业在这里是优势不是短板，深圳有子公司",
    "③ 国宁新储至今未开校招，不要等，偶尔关注即可",
    "④ CATL校招一直开着，专业门槛问题仍未解决，当冲刺项投",
    "⑤ 这些新设公司的校招窗口通常很窄（第一年最好进），看到公告要第一时间投",
]
...
# Section 5: 完整N档名单纯表
# ──────────────────────────────────────────────
add_heading2("五、完整 N档·新设扩产待核验 名单（按省份）")
add_para("注：以下企业来自原 Excel 分类 'N档·新设扩产待核验' + '新增补充'，校招状态请参考上一章节的验证结果。", size=9.5)
